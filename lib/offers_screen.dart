...
class _OffersScreenState extends State<OffersScreen> {
  Future<List<OfferModel>> fetchOffers() async {
    ...
    final String apiUrl = 'http://localhost:8000/api/offers';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color(0xFFF6F9FC), // خلفية ناعمة جداً تبرز البطاقات البيضاء
  ...
  Widget _buildOfferCard(BuildContext context, OfferModel offer) {
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        boxShadow: [
          BoxShadow(
            color: const Color(0xFF1E293B).withOpacity(0.04), // ظلال هادئة واحترافية
            blurRadius: 20,
                    ...
                    Row(
                      children: [
                        Container(
                          ...
                          child: const Icon(Icons.business_rounded, color: Color(0xFF64748B), size: 18),
                        ),
                    ...
                    children: [
                      ...
                      Expanded(
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            const Text("من", style: TextStyle(color: Color(0xFF94A3B8), fontSize: 11, fontWeight: FontWeight.w500)),
                      ...
                      const Padding(
                        ...
                        child: Row(
                          ...
                          children: [
                            Icon(Icons.directions_bus_rounded, color: Color(0xFF2ECC71), size: 18),
                            SizedBox(width: 6),
                            Icon(Icons.arrow_forward_rounded, color: Color(0xFF94A3B8), size: 20), // السهم يتجه لليمين
                          ],
                        ),
                      ),
                      ...
                      Expanded(
                        child: Column(
                          ...
                          children: [
                            const Text("إلى", style: TextStyle(color: Color(0xFF94A3B8), fontSize: 11, fontWeight: FontWeight.w500)),
                            const SizedBox(height: 4),
                            Text(
                              offer.to,
                              style: const TextStyle(color: Color(0xFF1E293B), fontWeight: FontWeight.bold, fontSize: 15),
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style: const TextStyle(
                            ...
                            decorationColor: Colors.redAccent, // خط التشطيب باللون الأحمر بطلبكِ
                            decorationThickness: 1.5, // سماكة ناعمة ومناسبة لخط الشطب
                            color: Color(0xFF94A3B8), // بقاء لون أرقام النص رمادي كما هو
                            fontSize: 14,
